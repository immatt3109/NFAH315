    ...
    public class ControlSystem : CrestronControlSystem
    {
        ...
        public override void InitializeSystem()
        {
            try
            {
                ...
                CrestronConsole.PrintLine("Sony Camera IP1: {0}", roomSetup.SonyCameras.Cameras[0].IpAddress);
                CrestronConsole.PrintLine("Sony Camera IP2: {0}", roomSetup.SonyCameras.Cameras[1].IpAddress);
                CrestronConsole.PrintLine("Mics Counnt: {0}", roomSetup.Microphones.Count);
                CrestronConsole.PrintLine("Microphone 1: {0}", roomSetup.Microphones[0].IpAddress);
                CrestronConsole.PrintLine("Microphone 2: {0}", roomSetup.Microphones[1].IpAddress);
